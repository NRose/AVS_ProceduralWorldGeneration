...
{
    /// <summary>
    /// Class that provides a methode to send a broadcast package.
    /// </summary>
    public static class BroadcastHelper
   {
      ...
      private static byte[] CONTENT = Encoding.ASCII.GetBytes("Service Request");
        ...
        /// <summary>
        /// Static method that sends an ip package with a service request to all reachable nodes (broadcast).
        /// </summary>
